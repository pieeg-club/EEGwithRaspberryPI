# The easiest way to the neuroscience world with the shield for RaspberryPi - [PIEEG](https://www.hackerbci.com/) (In progress). Real-Time signal processing GUI in python.  Open-source.
