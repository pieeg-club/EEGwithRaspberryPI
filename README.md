# The easiest way to the neuroscience world with the shield for RaspberryPi - [PIEEG](https://www.hackerbci.com/). GUI in python and for robot control. Open-source. [Crowdsupply](https://www.crowdsupply.com/hackerbci/pieeg)
